...
Route::middleware(['auth', 'can:is-admin'])->group(function () {
    ...
    // Painel e Notificações de Admin
    Route::get('/notificacoes', fn () => inertia('FunctionsApp/notificacoes'))->name('notificacoes');
    Route::get('/administracao', fn () => inertia('FunctionsApp/administracao'))->name('administracao');
});
